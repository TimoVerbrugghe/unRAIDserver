...
base-devel btrfs-progs openssh rsync wget curl ufw smartmontools sudo ntfs-3g ttf-dejavu haveged ccache libcdio libdvdread libdvdcss libdvdnav pacman-contrib irqbalance unzip cpupower
